...
<div style="text-align:">
  <img src="./image/PR_Curves_TEN-VAD-TestSet.png" width="800">
</div>
...
<div style="text-align:">
  <img src="./image/Agent-Friendly-image.png" width="800">
</div>
<br>
...
3. Follow the steps below to build and test on iOS device:
    ...
    <div style="text-align:">
      <img src="./image/ios_image_1.jpg" width="800">
    </div>
    ...
    - Note: If this step is not completed, you may encounter the following runtime error: "dyld: Library not loaded: @rpath/ten_vad.framework/ten_vad".
      ...
      <div style="text-align:">
        <img src="./image/ios_image_2.png" width="800">
      </div>
